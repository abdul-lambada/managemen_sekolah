...
--
-- Host: localhost:3306
-- Waktu pembuatan: 10 Okt 2025 pada 16.55
...
--
-- Stand-in struktur untuk tampilan `vw_active_templates`
...
--
-- Stand-in struktur untuk tampilan `vw_recent_whatsapp_logs`
-- (Lihat di bawah untuk tampilan aktual)
--
...
--
-- Stand-in struktur untuk tampilan `vw_whatsapp_stats`
-- (Lihat di bawah untuk tampilan aktual)
--
...
--
-- Indeks untuk tabel `cache_metadata`
--
...
--
-- Indeks untuk tabel `fingerprint_devices`
--
ALTER TABLE `fingerprint_devices`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `fingerprint_logs`
--
...
--
-- Indeks untuk tabel `tbl_jam_kerja`
--
...
--
-- Indeks untuk tabel `whatsapp_automation_config`
--
ALTER TABLE `whatsapp_automation_config`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `whatsapp_automation_logs`
--
...
--
-- Indeks untuk tabel `whatsapp_device_status`
--
...
--
-- Indeks untuk tabel `whatsapp_message_templates`
--
...
--
-- Indeks untuk tabel `whatsapp_rate_limits`
--
...
--
-- Indeks untuk tabel `whatsapp_templates`
--
...
--
-- Indeks untuk tabel `whatsapp_webhook_logs`
--
...
--
-- AUTO_INCREMENT untuk tabel `fingerprint_devices`
--
ALTER TABLE `fingerprint_devices`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `fingerprint_logs`
--
ALTER TABLE `fingerprint_logs`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_jam_kerja`
--
ALTER TABLE `tbl_jam_kerja`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT untuk tabel `whatsapp_automation_config`
--
ALTER TABLE `whatsapp_automation_config`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT untuk tabel `whatsapp_automation_logs`
--
ALTER TABLE `whatsapp_automation_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `whatsapp_device_status`
--
ALTER TABLE `whatsapp_device_status`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `whatsapp_message_templates`
--
ALTER TABLE `whatsapp_message_templates`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT untuk tabel `whatsapp_rate_limits`
--
ALTER TABLE `whatsapp_rate_limits`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `whatsapp_templates`
--
ALTER TABLE `whatsapp_templates`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `whatsapp_webhook_logs`
--
ALTER TABLE `whatsapp_webhook_logs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
