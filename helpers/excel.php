...
if (!function_exists('export_array_to_excel')) {
...
if (!function_exists('read_spreadsheet_to_array')) {
...
if (!function_exists('normalize_import_headers')) {
...
if (!function_exists('row_is_empty')) {
...
if (!function_exists('combine_row_with_headers')) {
